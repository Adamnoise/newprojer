...
export function Header() {
  ...
  return (
    <header
      className={cn(
        "fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b backdrop-blur-lg shadow",
    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <div className="px-3 py-1.5 rounded-md bg-muted/50 hover:bg-muted/80 transition-colors duration-200 flex items-center gap-2 border">
              <Trophy className="h-4 w-4 text-blue-400" />
              <span className="text-xs font-medium text-white">{userStats.points} Points</span>
            </div>

            <div className="px-3 py-1.5 rounded-md bg-muted/50 hover:bg-muted/80 transition-colors duration-200 border">
          ...
          >
            <button className="relative p-2 rounded-full bg-muted/50 hover:bg-muted/80 transition-colors duration-200 border">
              <Bell className="h-4 w-4 text-white" />
              <span className="absolute top-0 right-0 h-2 w-2 rounded-full bg-blue-500"></span>
            </button>

            <button className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-muted/50 hover:bg-muted/80 transition-colors duration-200 border">
